...
class AdminPostServiceTest {
    ...
    void createDraftRequiresTitleAndContent() {
        final AdminPostService service = new AdminPostService(
    ...
    void publishByIdSetsPublishedAtWhenMissing() {
        ...
        final AdminPostService service = new AdminPostService(repo, new NoOpFeedEventPublisher());
    ...
    void publishByIdEmitsEvent() {
        ...
        final AdminPostService service = new AdminPostService(repo, publisher);
