package com.skateboard.podcast.event.service.application.service;
...
public class PublicEventsService implements PublicEventsUseCase {

    private final EventRepository eventRepository;

    public PublicEventsService(final EventRepository eventRepository) {
    ...
    public List<EventSummaryView> listPublished(final int page, final int size) {
        ...
        return eventRepository.findPublished(page, size).stream()
                .map(PublicEventsService::toSummary)
                .toList();
    }
    ...
    public Optional<EventDetailsView> getBySlug(final String slug) {
        ...
        return eventRepository.findBySlug(slugValue)
                ...
                .map(PublicEventsService::toDetails);
    }
