...
class AdminPostsControllerTest {
    ...
    @Mock
    private AdminPostsUseCase adminPostsService;
    ...
    void setUp() {
        ...
        final AdminPostsController controller = new AdminPostsController(adminPostsService, postApiMapper);
    ...
    void adminPostCreate_returnsCreatedPost() throws Exception {
        ...
        given(adminPostsService.createDraft(
                eq("Draft Title"),
                eq("draft-title"),
                eq("Excerpt"),
                eq(List.of("news")),
    ...
    void adminPostUpdate_returnsUpdatedPost() throws Exception {
        ...
        given(adminPostsService.updateById(
                eq(postId),
                eq("Updated"),
                eq("updated"),
                eq("New excerpt"),
    ...
    void adminPostPublish_returnsPublishedPost() throws Exception {
        ...
        given(adminPostsService.publishById(postId)).willReturn(view);
