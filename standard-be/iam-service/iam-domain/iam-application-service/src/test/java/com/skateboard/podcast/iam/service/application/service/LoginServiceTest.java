...
class LoginServiceTest {
    ...
    @Test
    void loginRejectsBlankPasswordOrDeviceId() {
        ...
        assertThrows(ValidationException.class, () -> service.login("user@example.com", " ", "device", "phone"));
        assertThrows(ValidationException.class, () -> service.login("user@example.com", "secret", " ", "phone"));
    }
    ...
    void loginReturnsTokensAndPersistsRefreshToken() {
        ...
        assertEquals(userId, result.userId().value());
        assertNotNull(result.accessToken());
        assertNotNull(result.refreshToken());

        final String tokenHash = tokenProvider.hashRefreshToken(result.refreshToken());
        final var stored = tokens.findByTokenHash(tokenHash).orElseThrow();
